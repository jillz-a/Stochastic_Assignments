...
while iterations <= 1500:
    ...
    bsns_que = []       # business passenger que, contains passenger arrival times
    desks = [0,0,0]     # available desks, 0 if available, pax_arrival if not
    pax_arrival = 0     # passenger arrival time
    bsns_arrival = 0    # business passenger arrival time
    ...
    while time <= 180: # set the time interval in minutes
        ...
        # if all desk are full, note the waiting time = business passenger arrival time - next desk free time
        ...
        # if all desk are full, note the waiting time = passenger arrival time - next desk free time
...
#confidence intervals of passneger and business waiting time
